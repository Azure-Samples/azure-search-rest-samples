...
# Quickstart: ACL in Azure AI Search using REST
...
This sample is featured in [Query-time ACL and RBAC enforcement in Azure AI Search](https://learn.microsoft.com/en-us/azure/search/search-query-access-control-rbac-enforcement).
